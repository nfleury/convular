...
Convular.prototype.run = function(){
  ...
  //Monitor www changes and generate html
  generateHtml();
  Watch.createMonitor(www_dir, function (monitor) {
      monitor.on("changed", generateHtml);
  });
...
Convular.prototype.generateWWW = function () {
